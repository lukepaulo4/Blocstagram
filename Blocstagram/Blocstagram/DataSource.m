...
//The implementation will post the method to IG comments endpoint. If it succedds, it'll refetch the media with the new comment. If not, it simply reloads the row
